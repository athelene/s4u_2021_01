      ...
      <div class="card card-body">
        ...
        <div class="row mt-2">
          <div class="col-12 text-center">               
            <button id="newInvitations" href="/Circles/RSVPInvitation.cfm" class="btn btn-danger">
              Answer Invitations</button>
          </div>
        </div>
        ...
        <div class="row mt-2">
          <div class="col-12 text-right">               
            <button href="" class="btn btn-secondary" data-toggle="modal" data-target="#modalLoginForm">
              New Circle</button>
          </div>
        </div>
