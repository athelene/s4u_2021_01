...
<!--Large Navbar -->
<cfoutput>
  <div id="largeNav" class="d-none d-md-flex">
    <input type="hidden" id="sessionUserid" value="#session.Userid#">
    <nav class="navbar w-100">

      <a class="offset-1" href="/homepage.cfm">
        <img src="/assets/images/Logo_color_short.png" class="logo-short" />
      </a>
      ...
      <form class="form-inline my-2 my-lg-0 ml-auto" action="/SearchResults.cfm" name="simpleAJAX"
        ...
        <button class="btn btn-outline-white btn-md my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
      </form>
      ...
      <div class="dropdown-menu dropdown-menu-right dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
        ...
        <a class="dropdown-item" href="/circles/InviteNewMember.cfm">Invite New Member</a>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card card-body">
        ...
        <div class="input-group input-group-sm mb-3">
          <form class="form-inline my-2 my-lg-0 " action="/SearchResults.cfm" name="simpleAJAX" enctype="multipart/form-data" method="post">
            <input class="form-control" type="search" placeholder="Search" aria-label="Search" name="searchTerm"
